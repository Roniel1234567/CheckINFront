...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-CIGZDIGE.js";
import {
  internal_createExtendSxProp,
  useDefaultProps
} from "./chunk-RVLZIAOK.js";
import {
  _extends,
  alpha,
...
var TabScrollButton = React17.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React18.useRef();
...
var Tabs = React19.forwardRef(function Tabs2(inProps, ref) {
  ...
  let childIndex = 0;
  const children2 = React19.Children.map(childrenProp, (child) => {
...
function useAutocomplete(props) {
  ...
  const initialInputValue = React21.useRef(getInputValue(defaultValue, multiple, getOptionLabel)).current;
...
//# sourceMappingURL=chunk-4NJEX6IJ.js.map
